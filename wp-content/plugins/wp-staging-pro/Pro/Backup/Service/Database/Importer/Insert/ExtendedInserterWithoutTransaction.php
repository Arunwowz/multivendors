...
class ExtendedInserterWithoutTransaction extends QueryInserter
{
    ...
    protected function showError()
    {
        ...
        $this->logger->warning(__(sprintf('Could not import the query. MySQL has returned the error code %d, with message "%s".', $this->client->errno(), $this->client->error())) . $additionalInfo);
    }
