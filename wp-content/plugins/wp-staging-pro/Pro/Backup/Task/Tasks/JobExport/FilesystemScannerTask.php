...
class FilesystemScannerTask extends ExportTask
{
    ...
    public function execute()
    {
        ...
        if ($this->stepsDto->getCurrent() === 0) {
            $this->currentPathScanning = ExportOtherFilesTask::IDENTIFIER;
        ...
        if ($this->stepsDto->getCurrent() === 1) {
            $this->currentPathScanning = ExportPluginsTask::IDENTIFIER;
            $this->setupCompressorQueue();
        ...
        if ($this->stepsDto->getCurrent() === 2) {
            $this->currentPathScanning = ExportMuPluginsTask::IDENTIFIER;
            $this->setupCompressorQueue();
        ...
        if ($this->stepsDto->getCurrent() === 3) {
            $this->currentPathScanning = ExportThemesTask::IDENTIFIER;
            $this->setupCompressorQueue();
        ...
        if ($this->stepsDto->getCurrent() === 4) {
            $this->currentPathScanning = ExportUploadsTask::IDENTIFIER;
            $this->setupCompressorQueue();
    ...
    {
        $compressorTaskName = FileExportTask::getTaskName() . '_' . $this->currentPathScanning;
