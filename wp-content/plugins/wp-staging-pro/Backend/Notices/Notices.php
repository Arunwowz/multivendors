...
class Notices
{
    ...
    public function messages()
    {
        ...
        if (self::SHOW_ALL_NOTICES || (!is_executable($varsDirectory) || !is_readable($varsDirectory)) && isset($wpstgSettings->optimizer) && $wpstgSettings->optimizer) {
            require_once "{$viewsNoticesPath}/mu-plugin-directory-permission-problem.php";
        }
