...
<form action="<?php echo esc_url(admin_url("admin-post.php?action=wpstg_download_sysinfo")) ?>" method="post" dir="ltr">
    ...
    <div class="wpstg--tab--active" id="wpstg-report-issue-wrapper" style="max-width: 440px;padding-bottom:7px;">
        <?php submit_button("Download System Info", "primary", "wpstg-download-sysinfo", false) ?>
